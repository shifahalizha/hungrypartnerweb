        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <div class="row text-center text-white mb-5">
                <div class="col-lg-7 mx-auto">
                    <h1 class="display-4 my-3">Dessert</h1>
                    <h2 class="mb-4" style="font-size: 20px;">Elevate Your Senses with Heavenly Desserts!</h2>
                </div>
            </div>
            <div class="row">
            ...
            <div>
                <div class="row">
                    <?php if ($recipes && is_array($recipes)): ?>
                                        ...
                                        <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                                            <div class="media-body order-2 order-lg-1">
                                                <h5 class="mt-0 font-weight-bold mb-2"><a class="text-dark"
                                                        href="detaildessert.php?id=<?= $recipe['id'] ?>">
                                                        <?= $recipe['nama_menu'] ?>
                                                    </a></h5>
